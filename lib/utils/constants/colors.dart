...
class AppColors {
  ...
  static const Color error = Color(0xFFA53724);
  ...
  // Based On Theme
  static get darkLight => AppHelper.isDarkMode ? dark : light;
  static get darkLightInvert => AppHelper.isDarkMode ? light : dark;
}
